...
export default function EarthSceneWebGPU() {
    const containerRef = useRef<HTMLDivElement>(null);

    useEffect(() => {
        if (!containerRef.current) return;

        let camera: any, scene: any, renderer: any, controls: any, globe: any, clock: any;
        ...
        const init = async () => {
            ...
            // renderer.inspector = new Inspector(); // Inspector likely requires installing three-inspector-addon or implies manual import logic we don't need for prod
        ...
        const animate = () => {
            ...
            // globe.rotation.y += delta * 0.025; // using OrbitControls autoRotate for smoother interaction
            controls.update();
